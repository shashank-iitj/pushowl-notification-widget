...
var pushowl = {
    init: function () {
            ...
            <div id="pushowl-widget-container">
                <div class="pushowl-notification-widget">
                    <div class="pushowl-widget-bell-container">
                        <img src="` + this.endpoint + `/assets/images/ic_notifications_white_24px.svg" width="20" height="20" />
                    </div>
        ...
        this.addCSS(docHead, "https://fonts.googleapis.com/css?family=Montserrat", false);
    },
